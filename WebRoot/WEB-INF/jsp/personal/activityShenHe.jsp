	...
	<div class="inner activityInner" style="margin-top: 30px;">
		...
		<div class="mod-crumbs">
			<span>当前位置：</span> <a class="back-to-index"
				href="profile">用户中心</a><span class="arrow">»</span> <b>赛事审核</b>
		</div>
		<!-- }面包屑导航 -->
							...
							<c:forEach items="${activityList}" var="activitis" varStatus="index">
								<tr class="activityContent">
									...
									<td class="activitybtn">
										<a href="activityYesOrNo?uaid=${activitis.uaid}&state=1" class="btn btn-success">通过</a>
										<a href="activityYesOrNo?uaid=${activitis.uaid}&state=2" class="btn btn-danger">不通过</a>
									</td>
							</c:forEach>
						</c:if>
					</table>
				...
				<div class="o-personal-nav">
					<ul>
						...
						<c:if test="${sessionScope.radio == 1}">
							...
							<li><a href="mySite"><em><i></i>场馆审核</em>
							</a></li>
						</c:if>
					</ul>
				</div>
